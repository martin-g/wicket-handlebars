...
public class MustacheTemplate extends Behavior {
    ...
    private CharSequence compile(final Component component) {
        ...
        try {
	        Reader templateReader = WicketHandlebars.newTemplateReader(templateName.getObject(), component);
	        return WicketHandlebars.compile(templateReader, templateData.getObject(), component.getEscapeModelStrings());
        } catch (Exception e) {
